                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Import Masuk</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Import Log Masuk</h4>
                        <div class="mb-3">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-3">
                                Anda dapat mengimport data log masuk secara masal dengan menggunakan
                                <a href="<?= base_url();?>admin/gudang/generateExcel/masuk" style="color:var(--ct-code-color); font-weight:bold" download><code>Format Excel Berikut</code></a>.
                            </div>
                            <form class="parsley-examples" enctype="multipart/form-data" action="do_import" method="POST">
                                <div class="mb-3">
                                    ...
                                    <small class="text-danger">Data Import Maksimal 100 Baris</small>
                                </div>
                                <div>
