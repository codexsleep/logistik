            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Edit Data Atk</h4>
                        <a href="<?= base_url();?>admin/gudang/atk" type="button"
                            ...
                            <div class="parsley-examples">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nama" placeholder="ex: Simpang Raya" class="form-control"
                                        id="nama-input" value="<?= $atk['nama_atk'];?>"/>
                                </div>
 
                                <div class="mb-3">
                                    <label for="satuan" class="form-label">Satuan Barang<span
                                            class="text-danger">*</span></label>
                                    <input type="hidden" id="satuan-default" value="<?= $atk['satuan_atk'];?>"/>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="harga" placeholder="ex: 12000" class="form-control"
                                        id="harga-input" value="<?= $atk['harga_satuan'];?>"/>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="min" placeholder="ex: 100" class="form-control"
                                        id="min-input" value="<?= $atk['min_stok'];?>"/>
                                </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="form-check">
                                        <input type="radio" name="status" class="form-check-input" value="1"
                                            id="status-input" <?php if($atk['status']=='1'){ echo "checked";}?>>
                                        <label class="form-check-label">Aktif</label>
                                    </div>

                                    <div class="form-check">
                                        <input type="radio" name="status" class="form-check-input" value="2"
                                            id="status-input" <?php if($atk['status']=='2'){ echo "checked";}?>>
