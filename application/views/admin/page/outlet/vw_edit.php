            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Tambah Data Outlet (Cabang)</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="parsley-examples">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="area" class="form-control" id="area-input">
                                        <option value="">Pilih Area</option>
                                        <?php
                                        foreach ($getArea as $getArea) {
                                            ?>
                                            <option value="<?= $getArea['id']; ?>" <?php if($getArea['id']==$outlet['areaid']){ echo "selected";} ?>><?= $getArea['nama_area']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select> 
