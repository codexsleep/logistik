                        ...
                        <div id="message"></div>
                            ...
                            <form class="parsley-examples" id="#simlog-form">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="detail" placeholder="Detail Anggaran" class="form-control" id="detail-input" value="<?= $anggaran['detail'];?>"/>
                                </div>
                                <div class="mb-3">
                                    <label for="tahun" class="form-label">Tahun<span class="text-danger">*</span></label>
                                    <input type="number" name="tahun" placeholder="Tahun" class="form-control" id="tahun-input" value="<?= $anggaran['tahun'];?>"/>
                                </div>
                                <div class="mb-3">
                                    <label for="anggaranInventaris" class="form-label">Anggaran Inventaris<span class="text-danger">*</span></label>
                                    <input type="number" name="iventaris" placeholder="Anggaran Inventaris" class="form-control" id="inventaris-input" value="<?= $anggaran['anggaran_inventaris'];?>"/>
                                </div>
                                <div class="mb-3">
                                    <label for="anggaranGedung" class="form-label">Anggaran Gedung<span class="text-danger">*</span></label>
                                    <input type="number" name="gedung" placeholder="Anggaran Gedung" class="form-control" id="gedung-input" value="<?= $anggaran['anggaran_gedung'];?>"/>
                                </div>
                                <div class="text-end">
